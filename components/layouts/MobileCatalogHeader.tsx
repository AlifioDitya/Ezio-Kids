      ...
      <AnimatePresence>
        {isStickyVisible && (
          <motion.div
            ...
            className="md:hidden fixed top-[56px] left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-b border-gray-100 shadow-sm px-6 py-3 flex items-center justify-between"
          >
